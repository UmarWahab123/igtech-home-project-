...
$('.page-content').removeClass('hide');
 ...
 //this function is for dropzone file upload
  function dropzonesinglefunc(id,filesize,allowedfiles,inputname,filepath){
     var fileList = new Array;
     var fileListinput = new Array;
     var i =0;
     var sitedoc=   new Dropzone(id, {
             ...
             success:function(file, serverFileName) {
                 ...
                 fileListinput[i] =filepath+serverFileName;
                 i++;
                 $('input[name='+inputname+']').val(fileListinput);
             },
             removedfile:function(file) {
                 var path="/"+filepath;
                 var rmvFile = "";
