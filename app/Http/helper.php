...
if(!function_exists('myemail')){
        ...
        function myemail($emails,$subject,$email_template)
    {
        require base_path().'/vendor/autoload.php';
        $apikey='9bd075c69e520a106447fc0367901d5d';
        $secret='b748f230ab00f9832f8308832500b1fe';
        $mj = new \Mailjet\Client($apikey, $secret);
        ...
        $body = [
            'FromEmail' => "info@telefonpasning.digital",
            'FromName' => "Telefonpasning",
            'Subject' => $subject,
            'Text-part' => "",
            'Html-part' =>$email_template,
            //  'Cc' => [
            //     [
            //         'Email' => "boliestv21@gmail.com",
            //         'Name' => "BoliesTV"
            //     ]
            // ],
            'Recipients' => $to
...
function get_settings($column){
      $data=\App\Models\Settings::select($column)->first();
       $data = $data->$column;
       return $data;
    }
