...
<svg class="defs">
      ...
      <div class="swiper-container swiper-slider swiper-slider_fullheight swiper-digital" data-effect="circle-bg" data-loop="false" data-autoplay="4600" data-speed="1600" data-mousewheel="false" data-keyboard="false" data-circle-fill="url(#gradient1)">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide" data-circle-cx=".6" data-circle-cy=".5" data-circle-r=".18" style="background-image: url({{$row->image}});">
            ...
            <div class="swiper-slide-caption d-flex justify-content-center">
              ...
              <div>
                ...
                <h2 class="text-white bg-accent p-4 pt-lg-3 pl-lg-3 pr-lg-3" data-swiper-anime="{ &quot;animation&quot;: &quot;swiperContentRide&quot;, &quot;duration&quot;: 800, &quot;delay&quot;: 400 }"><span>{{$row->title}} </span></h2>

                <p class="text-white text-left mt-1" data-swiper-anime="{ &quot;animation&quot;: &quot;swiperContentRide&quot;, &quot;duration&quot;: 800, &quot;delay&quot;: 600 }">

                {{get_settings("company_name")}}&nbsp{{$row->description}}</p>
      ...
      <section class="bg-gray-lighter object-wrap decor-text" data-content="About">
        ...
        <div class="bg-decor d-flex align-items-center justify-content-end" data-parallax-scroll="{&quot;y&quot;: 50,  &quot;smoothness&quot;: 30}"><img src="{{asset('/frontend/images/bg-decor-4.png')}}" alt=""/>
        ...
        <div class="object-wrap__body object-wrap__body-sizing-1 object-wrap__body-md-left bg-image" style="background-image:  url({{asset('/frontend/images/about.jpg')}})"></div>

      </section>

      <section class="section-md bg-default decor-text" data-content="Features">

        <div class="bg-decor d-flex align-items-center" data-parallax-scroll="{&quot;x&quot;: -50,  &quot;smoothness&quot;: 30}"><img src="{{asset('/frontend/images/bg-decor-5.png')}}" alt=""/>
        ...
        <div class="container">
          ...
          <div class="row justify-content-md-center justify-content-lg-between row-50 align-items-center">
            ...
            <div class="col-md-7 col-lg-4">
              ...
              <figure class="image-sizing-1" data-parallax-scroll="{&quot;y&quot;: -50,  &quot;smoothness&quot;: 30}"><img src="{{asset('/frontend/images/home_business.png')}}" alt="" width="1481" height="2068"/>
      ...
      <section class="section section-sm context-dark bg-gray-darker section-cta">
        ...
        <div class="container">
          ...
          <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
            ...
            <div class="col-xl-2 text-xl-right"><a class="button button-primary" target="_blank" href="{{ url('/contact-us')}}">Contact</a></div>
      ...
      <section class="section-md bg-gray-lighter text-center decor-text" data-content="Team">
        ...
        <div class="bg-decor d-flex align-items-start" data-parallax-scroll="{&quot;y&quot;: -50,  &quot;smoothness&quot;: 30}"><img src="{{asset('/frontend/images/bg-decor-7.png')}}" alt=""/>
      ...
      <section class="section parallax-container context-dark decor-text" data-parallax-img="{{asset('/frontend/images/c.jpg')}}" data-content="Testimonials">
              ...
              <div class="item">
                ...
                <div class="quote-default">
                  ...
                  <div class="quote-default__text">
                    ...
                    <p class="q">  <?= (isset($value->content) ? $value->content : '') ?>
